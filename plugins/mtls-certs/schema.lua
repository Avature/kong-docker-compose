    ...
    fields = {
      ...
      { config = {
        ...
        fields = {
          ...
          { ca_private_key_path = { type = "string", default = "/usr/local/custom/kong/plugins/mtls-certs/example_certs/CA-key.pem" }, },
          { ca_private_key_passphrase = { type = "string", default = "1234" }, },
          { ca_certificate_path = { type = "string", default = "/usr/local/custom/kong/plugins/mtls-certs/example_certs/CA-cert.pem" }, },
